...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('./log/final_model.pt', map_location=device))
    ...
    torch.save(model.state_dict(), './log/final_model.pt')
    end_time = time.time()
    ...
    data_dir = "./result"
    final_test_df.to_csv(os.path.join(data_dir, 'final_result.csv'), index=False)
